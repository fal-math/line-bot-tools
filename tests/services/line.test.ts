import { pushTextV2 } from '../../src/services/line';
import { LINE_CHANNEL_ACCESS_TOKEN } from '../../src/config';
...
describe('services/line.pushTextV2', () => {
  ...
  it('builds correct payload and calls UrlFetchApp.fetch once', () => {
    pushTextV2('dummyTarget', 'hello, world');
    ...
    expect(options.headers.Authorization).toBe(`Bearer ${LINE_CHANNEL_ACCESS_TOKEN}`);
