...
describe('CalendarService#get', () => {
  ...
  it('parses clubPractice events correctly', () => {
    ...
    eventsMap[Config.Calendar.id.clubPractice] = [
      mockEvent(title, 'ignored', new Date('2025-07-10T12:00:00')),
    ];
  ...
  it('parses externalPractice events correctly', () => {
    ...
    eventsMap[Config.Calendar.id.externalPractice] = [
      mockEvent(title, '外部場所', new Date('2025-07-11T14:00:00')),
    ];
  ...
  it('parses internalDeadline events correctly', () => {
    ...
    eventsMap[Config.Calendar.id.internalDeadline] = [
      mockEvent(title, 'ignored', new Date('2025-07-14T00:00:00')),
    ];
